from MeshCNN.options.base_options import BaseOptions
...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument(
            '--run_test_freq', type=int, default=1,
            help='frequency of running test in training script'
        )
        self.parser.add_argument(
            '--continue_train', action='store_true',
            help='continue training: load the latest model'
        )
        self.parser.add_argument(
            '--epoch_count', type=int, default=1,
        ...
        self.parser.add_argument(
            '--which_epoch', type=str, default='latest',
        ...
        self.parser.add_argument(
            '--niter_decay', type=int, default=500,
        ...
        self.parser.add_argument(
            '--scale_verts', action='store_true',
            help='non-uniformly scale the mesh e.g., in x, y or z'
        )
        self.parser.add_argument(
            '--slide_verts', type=float, default=0,
